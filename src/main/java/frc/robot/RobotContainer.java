...
final JoystickButton raiseTraverseClimberBtn = new JoystickButton(assistController, XboxController.Button.kA.value);        
...
final JoystickButton lowerTraverseClimberBtn = new JoystickButton(assistController, XboxController.Button.kA.value);        
