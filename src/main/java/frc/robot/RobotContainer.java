...
private final XboxController driverController = new XboxController(0);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("ClimbLow", new ClimbLow( m_climbSystem ));
    SmartDashboard.putData("ClimbHigh", new ClimbHigh( m_climbSystem ));
    SmartDashboard.putData("ClimbMid", new ClimbMid( m_climbSystem ));
    SmartDashboard.putData("ClimbTraversal", new ClimbTraversal( m_climbSystem ));
...
final JoystickButton lockClimberBtn = new JoystickButton(assistController, XboxController.Button.kA.value);        
...
final JoystickButton unlockClimberBtn = new JoystickButton(assistController, XboxController.Button.kA.value);        
